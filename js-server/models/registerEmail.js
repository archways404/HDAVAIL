function registerEmailGetPlainTextContent(username, resetToken) {
    ...
    http://localhost:3000/setPassword?token=${resetToken}
...
function registerEmailGetHtmlContent(username, resetToken) {
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
        ...
        <a 
            href="http://localhost:3000/setPassword?token=${resetToken}" 
        ...
        <p><a href="http://localhost:3000/setPassword?token=${resetToken}">http://localhost:3000/setPassword?token=${resetToken}</a></p>
